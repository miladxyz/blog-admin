    ...
    <>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <span className="font-bold text-xl text-gray-900 hidden sm:block">Mehrnaz</span>
            </Link>
          ...
          {isOpen && (
            <div className="md:hidden py-4 border-t border-gray-200">
              <div className="flex flex-col gap-2">
                ...
                {/* Mobile Social Links */}
                <div className="flex items-center gap-3 px-4 py-2 mt-4 border-t border-gray-200 pt-4">
                  <a
                    href="https://www.linkedin.com/in/mehrnazbahramzadeh"
                    target="_blank"
                    rel="noopener noreferrer"
      ...
      {showScrollButton && (
        <div className="fixed bottom-8 right-8 z-50 flex flex-col gap-2">
          ...
          <button
            onClick={scrollToTop}
            className="w-12 h-12 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-110 flex items-center justify-center group"
          ...
          <button
            ...
            className="w-12 h-12 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-110 flex items-center justify-center group"
